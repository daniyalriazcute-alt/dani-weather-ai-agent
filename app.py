...
# Custom CSS for styling (NO SIDEBAR OVERRIDES)
st.markdown("""
<style>
    ...
    /* Sidebar - SIMPLE, NO OVERRIDES */
    .css-1d391kg, .css-1d391kg > div {
        background: rgba(10, 25, 40, 0.95) !important;
        border-right: 1px solid rgba(26, 58, 90, 0.3) !important;
    }
...
# ============================================================
# SIDEBAR - Using Streamlit's native sidebar with SIMPLE content
# ============================================================
with st.sidebar:
    # Simple text - NO HTML, NO CSS classes
    st.write("## 🌤️ About Dani")
    ...
    st.write("### 👨‍💻 Created with ❤️ by Daniyal Riaz")
